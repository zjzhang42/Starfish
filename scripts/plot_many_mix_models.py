...
if args.static:
    ...
    pset1 = ps.copy()
    pset1[5] = -20
    draw_phot1 = lnprob_all(pset1)
    pset2 = ps.copy()
    pset2[7] = -20
    draw_phot2 = lnprob_all(pset2)
    ...
    plt.savefig('mix_model.png', dpi=300)

    my_dict = {"wl":wl.tolist(), "data":data.tolist(), 
                "model1_hot":draw_phot2.tolist(), 
                "model2_cool":draw_phot1.tolist(),
                "composite":draw.tolist()}
    with open("mix_spec.json", 'w') as f: 
...
if args.animate:
    ...
    for i in range(n_draws):
        ...
        draws.append(draw)
        draws_cool.append(draw_phot1)
        draws_hot.append(draw_phot2)
    ...
    def animate(i):
        ...
        line1.set_data(wl, draws_cool[i])
