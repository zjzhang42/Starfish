...
class ThetaParam:
    ...
    def __init__(self, grid, vz=0.0, vsini=0.0, logOmega=0.0, Av=0.0, grid2=[3100, 3.8, 0.0], vz2=0.0, vsini2=0.0, logOmega2=0.0):
        ...
        self.vz2 = vz2
        self.vsini2 = vsini2
        self.logOmega2 = logOmega2 #log10Omega
    ...
    def __repr__(self):
        return "grid:{} vz:{} vsini:{} logOmega:{} Av:{} \
        grid2:{} vz2:{} vsini2:{} logOmega2:{}".format(self.grid, self.vz, self.vsini, self.logOmega, self.Av, self.grid2, self.vz2, self.vsini2, self.logOmega2)
